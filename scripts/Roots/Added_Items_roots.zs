...
bark_greatwood.creativeTab =<creativetab:roots>;
...
bark_silverwood.creativeTab =<creativetab:roots>;
...
var bark_charred = VanillaFactory.createItem("bark_charred");
bark_charred.creativeTab =<creativetab:roots>;
bark_charred.unlocalizedName="bark_charred";
bark_charred.textureLocation=ResourceLocation.create("contenttweaker:items/bark_charred");

bark_charred.register();

var bark_ironwood = VanillaFactory.createItem("bark_ironwood");
bark_ironwood.creativeTab =<creativetab:roots>;
bark_ironwood.unlocalizedName="bark_ironwood";
bark_ironwood.textureLocation=ResourceLocation.create("contenttweaker:items/bark_ironwood");

bark_ironwood.register();

var bark_olive = VanillaFactory.createItem("bark_olive");
bark_ironwood.creativeTab =<creativetab:roots>;
bark_olive.unlocalizedName="bark_olive";
bark_olive.textureLocation=ResourceLocation.create("contenttweaker:items/bark_olive");
