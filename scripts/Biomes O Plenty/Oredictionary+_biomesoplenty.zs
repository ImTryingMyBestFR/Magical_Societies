...
val additions={
    ...
    <ore:BOPtallgrass>:bopTgrass,
    <ore:deadBush>:bopDbush,
    <ore:BOPdeadBush>:bopDbush,
    <ore:desertPlants>:bopDbush,
    <ore:allFlowers>:bopFlowers,
    <ore:BOPFlowers>:bopFlowers,
    <ore:blockCactus>:bopCacti,
    <ore:desertflowers>:bopCacti,
    <ore:BOPCactus>:bopCacti,
    <ore:mushroom>:bopshrooms,
    <ore:BOPmushroom>:bopshrooms,
    <ore:lilyPad>:boplily,
    <ore:BOPlilyPad>:boplily,
    <ore:treeLeaves>:bopleavesground,
    <ore:BOPtreeLeaves>:bopleavesground,
    <ore:vine>:bopvine,
    <ore:BOPvine>:bopvine,
    <ore:flesh>:bopflesh,
    <ore:doorWood>:woodoodrs,
    <ore:sweets>:sweets,
    <ore:soil>:bopgrassblock
...
<ore:soilSandy>.add(<biomesoplenty:dried_sand>);
<ore:soilFungal>.add(<biomesoplenty:grass:8>);
