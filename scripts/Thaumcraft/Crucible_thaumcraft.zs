...
Crucible.registerRecipe("thaumcraft:metal_purification_quartz", "METALPURIFICATION", <thaumcraft:cluster:7>, <ore:oreQuartz>, [<aspect:metallum>*5,<aspect:ordo>*5]);
...
if(loadedMods.contains("embers")){
    ...
    Crucible.registerRecipe("thaumcraft:metal_purification_silver", "METALPURIFICATION", <thaumcraft:cluster:4>, <ore:oreSilver>, [<aspect:metallum>*5,<aspect:ordo>*5]);
    Crucible.registerRecipe("thaumcraft:metal_purification_nickel", "METALPURIFICATION", <contenttweaker:cluster_nickel>, <ore:oreNickel>, [<aspect:metallum>*5,<aspect:ordo>*5]);
    Crucible.registerRecipe("thaumcraft:metal_purification_aluminium", "METALPURIFICATION", <contenttweaker:cluster_aluminium>, <ore:oreAluminium>, [<aspect:metallum>*5,<aspect:ordo>*5]);
}